	...
	<div id="wrap" class="container clearfix">
		...
		<?php if (have_posts()) : while (have_posts()) : the_post();
			...
			<div class="type-page">
				...
				<h2 class="page-title entry-title"><?php _e('No matches', 'glades'); ?></h2>
				
				<div class="entry clearfix">
					
					<p><?php esc_html_e('Please try again, or use the navigation menus to find what you search for.', 'glades'); ?></p>
