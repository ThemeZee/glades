...
if ( empty( $slider_posts ) ) : ?>
	...
	<p class="post-slider-empty-posts">
		<?php _e('There is no featured content to be displayed in the slider. To set up the slider, go to Appearance → Customize  → Theme Options, and add a tag under Tag Name in the Featured Content section. The slideshow will then display all posts which are tagged with that keyword.', 'cardigan'); ?>
	</p>
...
add_filter('excerpt_length', 'cardigan_slideshow_excerpt_length');
...
remove_filter('excerpt_length', 'cardigan_slideshow_excerpt_length');
