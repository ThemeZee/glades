        ...
        public function render_content() {  ?>
			...
			<div class="upgrade-pro-version">
				...
				<span class="textfield">
					<?php printf( esc_html__( 'Purchase the Pro Version of %s to get additional features and advanced customization options.', 'glades' ), 'Anderson'); ?>
				</span>
			...
			<div class="upgrade-plugins">
				...
				<span class="customize-control-title"><?php esc_html_e( 'ThemeZee Plugins', 'glades' ); ?></span>
				
				<span class="textfield">
					<?php esc_html_e( 'Extend the functionality of your WordPress website with our customized plugins.', 'glades' ); ?>
				</span>
				
				<p>
					<a href="<?php echo esc_url( __( 'https://themezee.com/plugins/', 'glades' ) ); ?>?utm_source=customizer&utm_medium=button&utm_campaign=glades&utm_content=plugins" target="_blank" class="button button-secondary">
						<?php esc_html_e( 'Browse Plugins', 'glades' ); ?>
					</a>
