	...
	class Glades_Customize_Upgrade_Control extends WP_Customize_Control {
        ...
        public function render_content() {  ?>
			...
			<div class="upgrade-pro-version">
				...
				<p>
					<a href="http://themezee.com/themes/glades/?utm_source=customizer&utm_medium=button&utm_campaign=glades&utm_content=pro-version" target="_blank" class="button button-secondary">
			...
			<div class="upgrade-toolkit">
				...
				<p>
					<a href="http://themezee.com/addons/toolkit/?utm_source=customizer&utm_medium=button&utm_campaign=glades&utm_content=toolkit" target="_blank" class="button button-secondary">
			...
			<div class="upgrade-addons">
				...
				<p>
					<a href="http://themezee.com/addons/?utm_source=customizer&utm_medium=button&utm_campaign=glades&utm_content=addons" target="_blank" class="button button-secondary">
