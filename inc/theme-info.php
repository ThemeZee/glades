	...
	<div class="wrap theme-info-wrap">
		...
		<div class="important-links clearfix">
			<p><strong><?php esc_html_e( 'Theme Links', 'glades' ); ?>:</strong>
				<a href="<?php echo esc_url( 'https://themezee.com/themes/glades/?utm_source=theme-info&utm_medium=textlink&utm_campaign=glades&utm_content=theme-page' ); ?>" target="_blank"><?php esc_html_e( 'Theme Page', 'glades' ); ?></a>
				<a href="<?php echo get_template_directory_uri(); ?>/changelog.txt" target="_blank"><?php esc_html_e( 'Changelog', 'glades' ); ?></a>
				<a href="<?php echo esc_url( 'http://preview.themezee.com/glades/?utm_source=theme-info&utm_medium=textlink&utm_campaign=glades&utm_content=demo' ); ?>" target="_blank"><?php esc_html_e( 'Theme Demo', 'glades' ); ?></a>
				<a href="<?php echo esc_url( 'https://themezee.com/docs/glades-documentation/?utm_source=theme-info&utm_medium=textlink&utm_campaign=glades&utm_content=documentation' ); ?>" target="_blank"><?php esc_html_e( 'Theme Documentation', 'glades' ); ?></a>
				<a href="<?php echo esc_url( 'http://wordpress.org/support/view/theme-reviews/glades?filter=5' ); ?>" target="_blank"><?php esc_html_e( 'Rate this theme', 'glades' ); ?></a>
			</p>
		</div>
		<hr>
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( 'https://themezee.com/docs/glades-documentation/?utm_source=theme-info&utm_medium=button&utm_campaign=glades&utm_content=documentation' ); ?>" target="_blank" class="button button-secondary">
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-primary">
								<?php esc_html_e( 'Customize Theme', 'glades' ); ?>
							</a>
						</p>
					</div>
					...
					<div class="section">
						...
						<p>
							<a href="<?php echo esc_url( 'https://themezee.com/themes/glades/?utm_source=theme-info&utm_medium=button&utm_campaign=glades&utm_content=pro-version' ); ?>" target="_blank" class="button button-secondary">
		...
		<div id="theme-author">
			...
			<p><?php printf( esc_html__( '%1$s is proudly brought to you by %2$s. If you like this theme, %3$s :)', 'glades' ), 
				$theme->get( 'Name' ),
				'<a target="_blank" href="https://themezee.com/?utm_source=theme-info&utm_medium=footer&utm_campaign=glades" title="ThemeZee">ThemeZee</a>',
				'<a target="_blank" href="http://wordpress.org/support/view/theme-reviews/glades?filter=5" title="Glades Lite Review">' . esc_html__( 'rate it', 'glades' ) . '</a>'); ?>
			</p>
