...
class Glades_Featured_Content {
	 ...
	 * the transient is deleted by Glades_Featured_Content::validate_settings().
	 *
	...
	public static function customize_register( $wp_customize ) {
		$wp_customize->add_section( 'featured_content', array(
			...
			'description'    => sprintf( __( 'Use a <a href="%1$s">tag</a> to feature your posts. If no posts match the tag, <a href="%2$s">sticky posts</a> will be displayed instead.', 'glades' ),
				esc_url( add_query_arg( 'tag', _x( 'featured', 'featured content default tag slug', 'glades' ), admin_url( 'edit.php' ) ) ),
		...
		$wp_customize->add_setting( 'featured-content[tag-name]', array(
			'default'              => _x( 'featured', 'featured content default tag slug', 'glades' ),
			'type'                 => 'option',
		...
		$wp_customize->add_control( 'featured-content[hide-tag]', array(
			'label'    => __( 'Don&rsquo;t display tag on front end.', 'glades' ),
			'section'  => 'featured_content',
			'type'     => 'checkbox',
			'priority' => 30,
		) );
	...
	public static function get_setting( $key = 'all' ) {
		...
		$defaults = array(
			'hide-tag' => 1,
			'tag-id'   => 0,
			'tag-name' => _x( 'featured', 'featured content default tag slug', 'glades' ),
		);
	 ...
	 * delete the transient set in Glades_Featured_Content::get_featured_content().
	 *
	 * @static
	 * @access public
	 * @since Glades 1.0
