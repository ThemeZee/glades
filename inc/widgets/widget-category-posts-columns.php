...
class Glades_Category_Posts_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array(
			...
			'description' => __('Displays your latest posts from two specified categories. Please use this widget ONLY in the Magazine Homepage widget area.', 'glades')
		);
		parent::__construct('glades_category_posts_columns', __('Category Posts Columns (Glades)', 'glades'), $widget_ops);
